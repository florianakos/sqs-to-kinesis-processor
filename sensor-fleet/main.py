...
def generate_submission(device_id, invalid_probability=0.1):
    """
...
def send_submissions(sqs_client, submissions):
    print(f"Sending submission of {len(submissions)} messages")
...
def main():
    ...
    while True:
        ...
        except (EndpointConnectionError, ClientError, ResponseParserError):
            pass
